...
class CampsiteWeeklyAggregatesList(ListAPIView):
    queryset = models.CampsiteWeeklyAggregates.objects.all()
    serializer_class = serializers.CampsiteWeeklyAggregatesSerializer
